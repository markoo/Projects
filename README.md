...
[**Fibonacci Sequence**](https://github.com/markoo/Projects/blob/master/Numbers/fibonacci.py) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

[**Prime Factorization**](https://github.com/markoo/Projects/blob/master/Numbers/primeFactors.py) – Have the user enter a number and find all Prime Factors (if there are any) and display them.
